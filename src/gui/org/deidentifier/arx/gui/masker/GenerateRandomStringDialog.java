...
public class GenerateRandomStringDialog extends Dialog {
  ...
  private GenerateRandomStringMasker masker;
   ...
   */
  public GenerateRandomStringDialog(Shell parent, GenerateRandomStringMasker masker) {
