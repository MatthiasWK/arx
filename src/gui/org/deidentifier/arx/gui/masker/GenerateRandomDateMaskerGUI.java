...
public class GenerateRandomDateMaskerGUI extends MaskerTool implements MaskerGUI {
	public static void main (String [] args) {
		...
		final DateTime date = new DateTime(c1, SWT.CALENDAR);
		gridData = new GridData(GridData.HORIZONTAL_ALIGN_FILL);
	    gridData.horizontalSpan = 7;
	    date.setLayoutData(gridData);
		final DateTime time = new DateTime(c1, SWT.TIME);
		time.setTime(0, 0, 0);
	...
	public Composite loadMasker() {
		...
		*/
		...
		final DateTime date = new DateTime(mainComposite, SWT.CALENDAR);
		gridData = new GridData(GridData.HORIZONTAL_ALIGN_FILL);
	    gridData.horizontalSpan = 7;
	    date.setLayoutData(gridData);
		final DateTime time = new DateTime(mainComposite, SWT.TIME);
		time.setTime(0, 0, 0);
